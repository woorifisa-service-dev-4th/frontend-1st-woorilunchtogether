...
ff.addEventListener("click", (event) => {
  ...
  menuIndo.innerHTML = `
            <div id="name" class="text-[26px] font-bold">${renderedFoodInfo.name}</div>
            <div id="middle_left" class="menu_content_middle flex justify-between">
              <div id="address">
                <div class="text-[#0078B9]">0</div>
                <div id="address_info">${renderedFoodInfo.address}</div>
              </div>
              <div id="middle_right">
              <span id="price" class="flex justify-center">${renderedFoodInfo.price_per_person}원</span>
                <span id="food" class="flex justify-center pr-3">${renderedFoodInfo.representative_food}</span>
              </div>
            </div>
